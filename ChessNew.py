...
class Game(Frame):
    ...
    def setupGUI(self):
        ...
        highlight = Checkbutton(self.master, text = "Highlight?", font = ("TkDefaultFont", 12), width = 22)
        highlight.grid(row = 9, column = 0)

        # space between discard and board
        boardSpace = Label(self.master, width = 1)
        boardSpace.grid(row = 0, column = 9)
        ...
        discard1.grid(row = 0, column = 10, columnspan = 4)
        ...
        discard2.grid(row = 9, column = 10, columnspan = 4)
