...
class newGame(Frame):
    ...
    def setupGUI(self):
        ...
        #create buttons for each of the chess board tiles, initialized with the image of the piece located
        #on each tile by default (or the blank image for the other tiles)
        #the tiles are numbered with two digit codes, where the first number represents the row
